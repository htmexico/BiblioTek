...
begin
  ...
  begin
      ...
      begin
         ...
         AgregarEtiqueta_Campo( '260' ); // 260 - PUBLICACION, DISTRIB, ETC. (IMPRESIÓN)

         AgregarEtiqueta_Campo( '300' );     // 300 - Extensión del ITEM
         ...
         AgregarEtiqueta_Campo( '504' ); // 504 - Nota de Bibliografía
