          ...
          begin
             ...
             begin
                ...
                begin
                   ...
                   // QUITADA PORQUE SE ANEXA UNA URL PARA CONSULTAR EL ORIGINAL EN INGLÉS en la definicion del campo
                end
                ...
                begin
                   ...
                   begin
                      ...
                      begin
                         ...
                         DisplayWarningMessage( 'Error en identificador de campo por posición: '+cCampo+' '+cDescripcionOriginal, 'Error' )
                   end
                   else
                   begin
                      //
                   ...
                   begin
                      ...
                      begin
                         ...
                         begin
                            ...
                            // Colocar el tag {MARC}
                            // en el campo TESAURO de la definición del subcampo NIVEL_MARC=9
                            qryExecSQL.SQL.Clear;
                            qryExecSQL.SQL.Add( 'UPDATE marc_codigo21 ' );
