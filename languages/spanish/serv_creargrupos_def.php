<?php
  ...
  // ESPA&ntilde;OL
  $PAGE_TITLE_GRUPOS = "Configuración de Grupos de Usuarios";
  
  // PARA EDITAR 
  $LBL_HEADER_V1 = "Agregar un grupo";	
  $LBL_HEADER_V2 = "Modificar un grupo";	
  
  $LBL_TO_BE_ASIGNED = "[Por asignar]";
  
  $LBL_ID_GRUPO  	        = "ID Grupo";
  $LBL_NOMBRE_GRUPO         = "Nombre del Grupo";  
  ...
  $LBL_MAX_DIAS_PRESTAMO    = "D&iacute;as M&aacute;x. de pr&eacute;stamo";
  $LBL_MAX_ITEMS_PRESTADOS	= "M&aacute;x. Items prestados";
  ...
  $LBL_MAX_RESERVACIONES	= "M&aacute;x. Reservaciones";
  $LBL_PERMITIR_RESERVAS_SANCIONES = "Permitir Reservas con Sanciones";
  
  $LBL_MAX_RENOVACIONES		= "M&aacute;x. Renovaciones";
  ...
  $LBL_PERMITIR_RENOVA_SANCIONES = "Permitir renovaci&oacute;n con Sanciones";
  
  $LBL_PERMITIR_COMENTARIOS = "Permitir a los usuarios realizar comentarios a alg&uacute;n material";
  
  $LBL_SANCION_ECONOMICA    = "Permitir Sanci&oacute;n Econ&oacute;mica";
  $LBL_SANCION_HORAS		= "Permitir Sanci&oacute;n en Horas";
  ...
  $VALIDA_MSG_21 = "Necesita indicar el nombre del grupo";
