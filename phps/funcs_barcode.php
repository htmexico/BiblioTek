...
//Funcion para comprobar caracteres permitidos en diferentes codigos de barras 
function comprobar_codigo( $codigo, $codificacion ){
   
 	if ( $codificacion==4 ) $permitidos = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-.*$/+% ";
