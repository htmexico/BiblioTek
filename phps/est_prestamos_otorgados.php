<?php
	...
	/*******
	  ...
	  05 oct 2009: Se crea el producto.
	...
	include_language( "est_prestamos_otorgados" ); 	// archivo de idioma
...
<SCRIPT language="JavaScript">
	...
	function updateView()
	{
		...
		if( error == 0 )
		{
			...
			if( error == 0 )
			{
				var url = "est_prestamos_otorgados.php?desde=" + obj1.value + "&hasta=" + obj2.value;
      ...
      <div id="contenido_principal">
	   ...
	   <div id="info_general" class="caja_datos">
		   ...
		   <?php 
				...
				// PRESTMAMOS POR USUARIO			
				echo "<br><br>";
				echo "<hr>";
				echo "<h1>$LBL_CHAPTER_2</h1><br>";
				$prestamos = 0;
				$info_prestamos = estadisticas_obtener_info_prestamos_x_usuario( $db, $id_biblioteca, $fecha_desde, $fecha_hasta, $prestamos );
				
				for( $i=0; $i<count($info_prestamos); $i++ )
				{ 
					echo "&nbsp;<div class='mini_bullet'></div><strong>" . $info_prestamos[$i]["nombre_grupo"] . "</strong> = " . $info_prestamos[$i]["prestamos"] . "<br>" ; 
				}
