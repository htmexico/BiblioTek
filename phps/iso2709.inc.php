...
// ---------------------------------------------------
// constructor : récupération de l'enregistrement
// ---------------------------------------------------
	function iso2709_record( $string='', $update=AUTO_UPDATE ) 
	{
		...
		// recuperación del registro COMPLETO
		...
		// recuperación del DIRECTORIO
		//
		//
		
		// Tamaño de cada Entrada en el directorio
...
// ---------------------------------------------------
// 		Esta función devuelve el número de campos que se leyeron
// ---------------------------------------------------
...
// ---------------------------------------------------
	...
	function show_errors() {
		...
		{
			print 'Ningún error <br>';  // aucune erreur
		}
	}
