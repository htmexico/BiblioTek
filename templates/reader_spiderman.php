<style>
	...
	{ 
	  ...
	  font: bold 75% Comic Sans ms; /*TIPO DE FUENTE DE LAS CAJAS DE TEXTO*/
	  font-style:normal;
	} 
...
h1 {
	...
	color:#FF0000; /*COLOR DE FUENTE DE NOMBRE PRINCIPAL*/
	font-size:17px;
	 }
...
.caja_con_ligas h1 { /*COLOR, TAMAÑO ENCABEZADOS DE LIGAS RAPIDAS*/
	...
	letter-spacing:2px;
	color: #FFFFFF;
	font: bold 80% berlin sans fb;
	font-style:italic;
	}

.info {
	font: bold 105% Comic Sans ms; /*TIPO DE FUENTE DE INFO PRINCIPAL*/
	color:#FFFFFF;
	 } 

div.resaltados {
	overflow:auto;
	border: 3px solid #A2A2A2; /*COLOR DE BORDE NOTAS DESTACADAS*/
	padding: 10px;
	font-size: 88%;
	color:#FFFFFF;
	background:url(templates/images/fondo_borde_spider.jpg);
}

div.resaltados h2 
{
	margin:0; 
	color:#FF0000; /*ENCABEZADO NOTAS DESTACADAS*/
	font: bold 120% Arial;
}
...
#contenedor {
	...
	background-image:url(templates/images/fondo_spider.jpg);
	width:960px;
	margin:0 auto;
	position:relative;
	text-align: left;
...
background: #F8DCB8;   
   ...
   div.lista_elementos_indexada
	...
	background: url(templates/images/idex_spider.png) no-repeat left top;
	width:auto;
...
.sp_hint {
    ...
    within the box */
    background: #fff url(../bullets/pointer_purple.gif) no-repeat -10px 5px;
}
...
<h1><img src="templates/iconos/spider.png" width="40" height="40" /><?php echo getsessionvar("nombreusuario");?></h1>
...
<div class='caja_con_ligas'>
	...
	<div class='lista_elementos_indexada' style='width:49%'>
		<h1><span class="lista_elementos_indexada" style="width:49%"></span><img src="templates/iconos/search_spider.png" width="32" height="32" /><?php echo  $RECENT_USED_ITEMS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/favorites_spider.png" width="32" height="32" /><?php echo $MOST_FRECUENT_SUBJECTS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/dowload__venon.png" width="32" height="32" /><?php echo $RECENT_CONTRIBUTIONS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/psp.png" width="32" height="32" /><?php echo $RECENT_ACTIVITIES;?></h1>
...
<div id='contenido_adicional'>
	...
	<div class='resaltados'>
		<h2><img src="templates/iconos/space_spider.png" width="40" height="40" /><?php echo $VIRTUAL_STORAGE_SPACE;?></h2>
		<br>
<?php
