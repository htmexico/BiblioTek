<style>
	...
	{ 
	  ...
	  font: normal 80% Calibri; /*TIPO DE FUENTE DE LAS CAJAS DE TEXTO*/
	  font-style:normal;
	} 
...
div.resaltados {
	overflow:auto;
	border: 4px solid #034254; /*COLOR DE BORDE NOTAS DESTACADAS*/
	padding: 10px;
	font-size: 88%;
	color: #FFFFFF;
	background: url(templates/images/fondo_borde_blue.jpg);
}

div.resaltados h2 
{
	margin:0; 
	color:#00CCFF; /*ENCABEZADO NOTAS DESTACADAS*/
	font-size: 15px;
...
#contenedor {
	...
	background-image:url(templates/images/fondo_abs_blue.jpg);
	width:960px;
	margin:0 auto;
	position:relative;
	text-align: left;
	color: #FFFFFF; /*color de texto de ligas rapidas viñetas*/
...
.sp_hint {
    ...
    within the box */
    background: #034254 url(templates/bullets/pointer_abs_blue.gif) no-repeat -10px 5px;
}

/* The pointer image is hadded by using another span */
.sp_hint .hint-pointer {
    
    background: url(templates/bullets/pointer_abs_blue.gif) left top no-repeat;
}
...
<h1><img src="templates/iconos/Blue.png" width="32" height="32" /><?php echo getsessionvar("nombreusuario");?></h1>
...
<div class='caja_con_ligas'>
	...
	<div class='lista_elementos_indexada' style='width:49%'>
		<h1><span class="lista_elementos_indexada" style="width:49%"></span><img src="templates/iconos/USB Drive.png" width="32" height="32" /><?php echo  $RECENT_USED_ITEMS;?></h1>

<?php
	USER_HISTORY_RecentUsedItems( getsessionvar("id_biblioteca"), getsessionvar("id_usuario") );
?>
	</div>

	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/Button_favorit.png" width="32" height="32" /><?php echo $MOST_FRECUENT_SUBJECTS;?></h1>

<?php	
	
	USER_HISTORY_MostFrequentlyViewed( getsessionvar("id_biblioteca"), getsessionvar("id_usuario") );
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/Torrents.png" width="32" height="32" /><?php echo $RECENT_CONTRIBUTIONS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/AIM.png" width="32" height="32" /><?php echo $RECENT_ACTIVITIES;?></h1>
...
<div id='contenido_adicional'>
	...
	<div class='resaltados'>
		<h2><img src="templates/iconos/Macbook.png" width="40" height="40" /><?php echo $VIRTUAL_STORAGE_SPACE;?></h2>
		<br>
<?php
