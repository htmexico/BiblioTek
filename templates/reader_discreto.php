...
h1 {
	...
	color:#660000; /*COLOR DE FUENTE DE NOMBRE PRINCIPAL*/
	font-size:19px;
...
div.resaltados {
	overflow:auto;
	border: 2px solid #993300; /*COLOR DE BORDE NOTAS DESTACADAS*/
	padding: 10px;
	font-size: 88%;
	color: #993300;
...
background-image:url(templates/images/fondo_discreto.jpg);
	width:960px;
	margin:0 auto;
	position:relative;
	text-align: left;
...
.sp_hint {
    ...
    within the box */
    background: #fceddd url(../bullets/pointer_discreto.gif) no-repeat -10px 5px;
}

/* The pointer image is hadded by using another span */
.sp_hint .hint-pointer {
    background: url(templates/bullets/pointer_discreto.gif) left top no-repeat;
}
...
width: 20px; 
height: 13px; 
background: url(templates/bullets/bullet_discreto.png) left top no-repeat; 
} 	
...
<h1><img src="templates/iconos/User.png" width="48" height="48" /><?php echo getsessionvar("nombreusuario");?></h1>
...
<div class='caja_con_ligas'>
	...
	<div class='lista_elementos_indexada' style='width:49%'>
		<h1><span class="lista_elementos_indexada" style="width:49%"></span><img src="templates/iconos/Document-matte.png" width="32" height="32" /><?php echo  $RECENT_USED_ITEMS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/System-matte.png" width="32" height="32" /><?php echo $MOST_FRECUENT_SUBJECTS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/Downloads-glossy.png" width="32" height="32" /><?php echo $RECENT_CONTRIBUTIONS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/SharePoint-glossy.png" width="32" height="32" /><?php echo $RECENT_ACTIVITIES;?></h1>
...
<div id='contenido_adicional'>
	...
	<div class='resaltados'>
		<h2><img src="templates/iconos/computer_monitor.png" width="48" height="48" /><?php echo $VIRTUAL_STORAGE_SPACE;?></h2>
		<br>
<?php
