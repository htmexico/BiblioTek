<style>
	...
	{ 
	  ...
	  font: bold 70% Arial Unicode MS; /*TIPO DE FUENTE DE LAS CAJAS DE TEXTO*/
	  font-style:italic;
	} 
...
h1 {
	...
	color:#000099; /*COLOR DE FUENTE DE NOMBRE PRINCIPAL*/
	font-size:16px;
	 }
...
.info {
	font: bold 100% Arial Unicode MS; /*TIPO DE FUENTE DE INFO PRINCIPAL*/
	color:#CC3333;
	font-style:italic;
	 } 
...
div.resaltados {
	overflow:auto;
	border: 2px solid #CC0000; /*COLOR DE BORDE NOTAS DESTACADAS*/
	padding: 10px;
	font-size: 88%;
	color: #000066;
	background:url(templates/images/fondo_borde_cars.jpg);
}

div.resaltados h2 
{
	margin:0; 
	color:#000099; /*ENCABEZADO NOTAS DESTACADAS*/
...
#contenedor {
	...
	background-image:url(templates/images/fondo_cars.jpg);
	width:960px;
	margin:0 auto;
	position:relative;
	text-align: left;
...
background: #F8DCB8;   
  ...
  div.lista_elementos_indexada
	...
	background: url(templates/images/tab_cars.png) no-repeat left top;
...
.sp_hint {
    ...
    within the box */
    background: #fff url(../bullets/pointer_cars.gif) no-repeat -10px 5px;
}

/* The pointer image is hadded by using another span */
.sp_hint .hint-pointer {
    background: url(templates/bullets/pointer_cars.gif) left top no-repeat;
}
...
width: 20px; 
height: 13px; 
background: url(templates/bullets/bullet_cars.png) left top no-repeat; 
} 	 
...
<h1><img src="templates/iconos/camaro.png" width="40" height="40" /><?php echo getsessionvar("nombreusuario");?></h1>
...
<div class='caja_con_ligas'>
	...
	<div class='lista_elementos_indexada' style='width:49%'>
		<h1><span class="lista_elementos_indexada" style="width:49%"></span><img src="templates/iconos/tem_lambor.png" width="32" height="32" /><?php echo  $RECENT_USED_ITEMS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/favo_ferr.png" width="32" height="32" /><?php echo $MOST_FRECUENT_SUBJECTS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/cont_citroen.png" width="32" height="32" /><?php echo $RECENT_CONTRIBUTIONS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/mustang.png" width="32" height="32" /><?php echo $RECENT_ACTIVITIES;?></h1>
...
<div id='contenido_adicional'>
	...
	<div class='resaltados'>
		<h2><img src="templates/iconos/space_card.png" width="40" height="40" /><?php echo $VIRTUAL_STORAGE_SPACE;?></h2>
		<br>
<?php
