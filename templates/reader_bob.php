<style>
	...
	{ 
	  ...
	  font: normal 90% Berlin Sans FB; /*TIPO DE FUENTE DE LAS CAJAS DE TEXTO*/
	  font-style:normal;
	} 

	h1, h3, h4, h5 
{
	font-family:Comic Sans MS; /*FUENTE DE ENCABEZADOS PRINCIPALES*/
}
...
.info {
	font: normal 120% Berlin Sans FB; /*TIPO DE FUENTE DE INFO PRINCIPAL*/
	color:#0066FF;
	 } 

div.resaltados {
	overflow:auto;
	border: 4px solid #bfe5ea; /*COLOR DE BORDE NOTAS DESTACADAS*/
	padding: 10px;
	font-size: 88%;
	background:url(templates/images/fondo_borde_bob.jpg);
	color: #0066FF;
}
...
div.resaltados h2 
{
	...
	font: normal 160% Berlin Sans FB;
}
...
#contenedor {
	...
	background-image:url(templates/images/fondo_bob.jpg);
	width:960px;
	margin:0 auto;
	position:relative;
	text-align: left;
	color: #333333; /*color de texto de ligas rapidas viñetas*/
...
/* submenus */
	...
	.caja_con_ligas h1
	{
		background: url(templates/images/enc_bob.png) no-repeat left top;
		width: 310px;
		padding:10px;
	}
	...
	background: url(templates/images/idex_bob.png) no-repeat left top;
...
.sp_hint {
    ...
    within the box */
    background: #D7EFFF url(../bullets/pointer_bob.gif) no-repeat -10px 5px;
}

/* The pointer image is hadded by using another span */
.sp_hint .hint-pointer {
    background: url(templates/bullets/pointer_bob.gif) left top no-repeat;
}
...
<h1><img src="templates/iconos/bob_photo.png" width="40" height="40" /><?php echo getsessionvar("nombreusuario");?></h1>
...
<div class='caja_con_ligas'>
	...
	<div class='lista_elementos_indexada' style='width:49%'>
		<h1><span class="lista_elementos_indexada" style="width:49%"></span><img src="templates/iconos/Locker.png" width="32" height="32" /><?php echo  $RECENT_USED_ITEMS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/bob_fav.png" width="32" height="32" /><?php echo $MOST_FRECUENT_SUBJECTS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/bob_contrib.png" width="32" height="32" /><?php echo $RECENT_CONTRIBUTIONS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/bob_activ.png" width="32" height="32" /><?php echo $RECENT_ACTIVITIES;?></h1>
...
<div id='contenido_adicional'>
	...
	<div class='resaltados'>
		<h2><img src="templates/iconos/bob_space.png" width="40" height="40" /><?php echo $VIRTUAL_STORAGE_SPACE;?></h2>
		<br>
<?php
