<style>
	...
	{ 
	  ...
	  font: normal 85% Berlin Sans FB; /*TIPO DE FUENTE DE LAS CAJAS DE TEXTO*/
	  font-style:normal;
	} 
...
.info {
	font: normal 110% Berlin Sans FB; /*TIPO DE FUENTE DE INFO PRINCIPAL*/
	color:#FF6699;
	 } 

div.resaltados {
	overflow:auto;
	border: 4px solid #ccc; /*COLOR DE BORDE NOTAS DESTACADAS*/
	padding: 10px;
	font-size: 88%;
	background: url(templates/images/fondo_borde_pink.jpg);
	color: #333333;
}
...
{
	margin:0; 
	color:#FF3399; /*ENCABEZADO NOTAS DESTACADAS*/
...
#contenedor {
	...
	background-image:url(templates/images/fondo_pink.jpg);
	width:960px;
	margin:0 auto;
	position:relative;
	text-align: left;
...
.sp_hint {
    ...
    within the box */
    background: #ffe8e8 url(../bullets/pointer_pink.gif) no-repeat -10px 5px;
}

/* The pointer image is hadded by using another span */
.sp_hint .hint-pointer {
       background: url(templates/bullets/pointer_pink.gif) left top no-repeat;
}
...
width: 20px; 
height: 13px; 
background: url(templates/bullets/bullet_pink.png) left top no-repeat; 
} 	
...
<h1><img src="templates/iconos/Magenta.png" width="40" height="40" /><?php echo getsessionvar("nombreusuario");?></h1>
...
<div class='caja_con_ligas'>
	...
	<div class='lista_elementos_indexada' style='width:49%'>
		<h1><span class="lista_elementos_indexada" style="width:49%"></span><img src="templates/iconos/Coversutra.png" width="32" height="32" /><?php echo  $RECENT_USED_ITEMS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/Fav.png" width="32" height="32" /><?php echo $MOST_FRECUENT_SUBJECTS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/Pictures drive.png" width="32" height="32" /><?php echo $RECENT_CONTRIBUTIONS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/Crystal.png" width="32" height="32" /><?php echo $RECENT_ACTIVITIES;?></h1>
...
<div id='contenido_adicional'>
	...
	<div class='resaltados'>
		<h2><img src="templates/iconos/Computer_pink.png" width="40" height="40" /><?php echo $VIRTUAL_STORAGE_SPACE;?></h2>
		<br>
<?php
