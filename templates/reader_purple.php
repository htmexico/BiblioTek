<style>
	...
	h1, h3, h4, h5 
{
	font-family:Berlin Sans fb; /*FUENTE DE ENCABEZADOS PRINCIPALES*/
...
h1 {
	...
	color:#710071; /*COLOR DE FUENTE DE NOMBRE PRINCIPAL*/
	font-style: normal;
	font: normal 170% berlin sans fb;
	 }
...
.info {
	font: normal 120% Calibri; /*TIPO DE FUENTE DE INFO PRINCIPAL*/
	color:#663399;
	 } 

div.resaltados {
	overflow:auto;
	border: 2px solid #DD99DD; /*COLOR DE BORDE NOTAS DESTACADAS*/
	padding: 10px;
	font-size: 88%;
	background:#FFFFFF;
}
...
{
	margin:0; 
	color:#663399; /*ENCABEZADO NOTAS DESTACADAS*/
...
#contenedor {
	...
	background-image:url(templates/images/fondo_purple.jpg);
	width:960px;
	margin:0 auto;
	position:relative;
	text-align: left;
	color: #000000; /*color de texto de ligas rapidas viñetas*/
}
...
.sp_hint {
    ...
    within the box */
    background: #e1ceeb url(templates/bullets/pointer_purple.gif) no-repeat -10px 5px;
}

/* The pointer image is hadded by using another span */
.sp_hint .hint-pointer {
    background: url(templates/bullets/pointer_purple.gif) left top no-repeat;
}
...
width: 20px; 
height: 13px; 
background: url(templates/bullets/bullet_purple.png) left top no-repeat; 
} 	 
...
<h1><img src="templates/iconos/Grape.png" width="40" height="40" /><?php echo getsessionvar("nombreusuario");?></h1>
...
<div class='caja_con_ligas'>
	...
	<div class='lista_elementos_indexada' style='width:49%'>
		<h1><span class="lista_elementos_indexada" style="width:49%"></span><img src="templates/iconos/Search.png" width="32" height="32" /><?php echo  $RECENT_USED_ITEMS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/favorites.png" width="32" height="32" /><?php echo $MOST_FRECUENT_SUBJECTS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/Spray.png" width="32" height="32" /><?php echo $RECENT_CONTRIBUTIONS;?></h1>
...
?>
	...
	<div class='lista_elementos_indexada' style='width:48%'>
		<h1><img src="templates/iconos/Puma viollet.png" width="32" height="32" /><?php echo $RECENT_ACTIVITIES;?></h1>
...
<div id='contenido_adicional'>
	...
	<div class='resaltados'>
		<h2><img src="templates/iconos/Virtual.png" width="40" height="40" /><?php echo $VIRTUAL_STORAGE_SPACE;?></h2>
		<br>
<?php
